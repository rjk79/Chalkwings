...
<br/ >
  ...
  <br/> <div className="subtitle">One-arm Pull-up: </div> (Inspired by Alex Puccio) While difficult, make sure you squeeze the bar as hard as you can, start with your body perpendicular to the bar, and fold your body inwards.
    ...
    otherInfo(){
        ...
        ,"Climb faster.If you can do the same moves but in a shorter amount of time without swinging recklessly, you are objectively climbing better.Your performance / max strength will drop significantly after being on the wall roughly more than a minute. "
